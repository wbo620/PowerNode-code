...
public class CarExample {
    ...
    public CarExample(String orderByClause, boolean distinct, List<Criteria> oredCriteria) {
    ...
    public String toString() {
        return "CarExample{orderByClause = " + orderByClause + ", distinct = " + distinct + ", oredCriteria = " + oredCriteria + "}";
    }
